...
<form on:submit|preventDefault={() => console.log($formData)} class="flex flex-col items-center justify-center h-full py-5 lg:py-0">
        ...
        <ul class="grid w-full gap-3 md:grid-cols-2">
            <li>
                ...
                <label for="hosting-small" class="inline-flex items-center w-full p-5 text-gray-700 bg-white border border-gray-300 rounded-lg cursor-pointer peer-checked:border-green-600 peer-checked:text-green-600 hover:text-gray-600 hover:bg-gray-100 ">                           
                    <svg  class="w-12" viewBox="0 0 75 75" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none">
            ...
            <li>
                ...
                <label for="hosting-big" class="inline-flex items-center gap-2 w-full p-5 text-gray-700 bg-white border border-gray-300 rounded-lg cursor-pointer  dark:peer-checked:text-green-500 peer-checked:border-green-600 peer-checked:text-green-600 hover:text-gray-600 hover:bg-gray-100 ">
                    ...
                    <svg class="w-12" viewBox="0 0 75 74.999997" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none">
    ...
    <div class="mt-10 flex gap-2">
        ...
        {/if}
        {#if $currentStep === 8}
        <button type="submit" class="flex items-center justify-center bg-green-500 text-white px-5 py-1.5 rounded-full hover:bg-green-600 font-bold transition ease-in-out" on:click={submitForm} >
            <svg class="mr-3 -ml-1 size-5 animate-spin text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class:hidden={$isLoading}>
