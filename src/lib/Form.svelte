...
<form on:submit|preventDefault={() =>  gtag('event', 'conversion', {'send_to': 'AW-17656917653/ABC123XYZ456','value': 1.0,'currency': 'EUR'}) } class="flex flex-col items-center justify-center h-full py-5 ">
    {#if $currentStep === 1}
        ...
        <ul class="grid w-full gap-3 md:grid-cols-2">
            <li>
                ...
                <label for="hosting-small" class="inline-flex items-center w-full px-3 py-5 text-gray-700 bg-white border border-gray-300 rounded-lg cursor-pointer peer-checked:border-green-600 peer-checked:text-green-600 hover:text-gray-600 hover:bg-gray-100 ">                           
                    <svg  class="w-12" viewBox="0 0 75 75" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
            ...
            <li>
                ...
                <label for="hosting-big" class="inline-flex items-center gap-2 w-full px-3 py-5 text-gray-700 bg-white border border-gray-300 rounded-lg cursor-pointer  dark:peer-checked:text-green-500 peer-checked:border-green-600 peer-checked:text-green-600 hover:text-gray-600 hover:bg-gray-100 ">
                    
                    <svg class="w-12" viewBox="0 0 75 74.999997" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
    ...
    {#if $currentStep === 2}
        ...
        <ul class="grid w-full gap-3 md:grid-cols-2">
            ...
            <li>
                ...
                <label for="owner" class="inline-flex items-center gap-2 w-full p-3 text-gray-700 bg-white border border-gray-200 rounded-lg cursor-pointer  dark:peer-checked:text-green-500 peer-checked:border-green-600 peer-checked:text-green-600 hover:text-gray-600 hover:bg-gray-100 ">
                    <svg class="w-14" viewBox="0 0 75 74.999997" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
            ...
            <li>
                ...
                <label for="locataire" class="inline-flex items-center w-full p-3 text-gray-700 bg-white border border-gray-200 rounded-lg cursor-pointer peer-checked:border-green-600 peer-checked:text-green-600 hover:text-gray-600 hover:bg-gray-100 ">                           
    ...
    {#if $currentStep === 9}
        ...
        <div class="p-4 mb-4 text-sm text-center text-green-800 rounded-lg bg-green-100 " role="alert">
            <p class="font-bold">
                Merci ! Votre demande a bien été prise en compte.
            </p>
            <p>
                Un de nos techniciens vous recontactera dans les plus brefs délais.
            </p>          
        </div>
    {/if}
